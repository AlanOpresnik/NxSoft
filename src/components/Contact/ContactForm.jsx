            ...
            <div className="container px-5 pt-6 pb-24 mx-auto">
                <div className="flex flex-col text-center w-full mb-12">
                    ...
                    <p className="lg:w-2/3 mx-auto leading-relaxed">
                        Mandanos un <span className='text-yellow-300'>correo</span> para poder brindarte una <span className='text-yellow-300'>atencion personalizada</span>
                    </p>
                </div>
                <form onSubmit={handleSubmit} className="lg:w-1/2 md:w-2/3 mx-auto">
                    <div className="flex flex-wrap -m-2">
                        ...
                        <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                            <a className="text-yellow-300">NxSoft@gmail.com</a>
